...
export default function CoupleBondSection({ items, onMovieClick }) {
    ...
    return (
        <div className="py-8 px-4 md:py-12 md:px-8 transition-all duration-300 bg-transparent">
            {/* Header Section */}
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 gap-4">
                <div className="max-w-2xl">
                    <h2 className="text-3xl md:text-4xl font-bold mb-3 leading-tight text-white">Couple Bond Section</h2>
                    <p className="text-gray-400 text-base leading-relaxed">
                        Strengthen your connection through these curated sessions designed for powerful shared experiences.
                    </p>
                </div>
