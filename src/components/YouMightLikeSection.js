...
export default function YouMightLikeSection({ items, onMovieClick }) {
    ...
    return (
        <div className="py-8 px-4 md:py-12 md:px-8 rounded-[20px] md:rounded-[40px] transition-all duration-300 bg-white/5 border border-white/10 backdrop-blur-sm">
            ...
            {/* Cards Section - Added scrollbar-hide to ensure no slider is shown */}
            <div
                ref={scrollContainerRef}
                className="w-full grid grid-cols-2 md:flex gap-4 md:gap-6 md:overflow-x-auto pb-4 md:pb-0 pt-2 scrollbar-hide md:scroll-smooth"
            >
